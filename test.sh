...
sample_data="\x1e\x00\x0c\x02\x00\x38\x00\x01\x00\x02\x00\x00\x00\x55\x55\x01\x02\x2c\x11\x00\x00\x00\x00\x04\x82\x0c\x01\x08\x0b\x91\x73\x60\x50\x84\x36\xf3\x82\x0c\x02\x08\x07\x91\x73\x60\x99\x05\x11\xf5\x80\x08\x01\x01\x58\x55\x55\x55\x08\x04\x01\xa9\x01\x60"
...
expected_result="\
\x00\x01\x00\x01\x02\x00\
\x07\x91\x16\x14\x91\x09\x10\xF0\x00\x00\x00\x00\
\x15\x00\x00\x00\x33\
\x0A\x91\x40\x30\x87\x00\x47\x00\x00\x00\x00\x00\
\xA7\x00\x00\x00\x00\x00\x00\xC8\x34\x28\xC8\x66\xBB\x40\x54\x74\x7A\x0E\x6A\x97\xE7\xF3\xF0\xB9\x0C\xBA\x87\xE7\xA0\x79\xD9\x4D\x07\xD1\xD1\xF2\x77\xFD\x8C\x06\x19\x5B\xC2\xFA\xDC\x05\x1A\xBE\xDF\xEC\x50\x08"
...
echo -n "### fbus_encapsulate "

sample_data="\x00\x01\x00\x03\x00"
expected_result="\x1E\x00\x0C\x02\x00\x07${sample_data}\x01\x43\x00\x51\x06"
result="$(fbus_encapsulate "$sample_data")"
test "$result" == "$expected_result" && echo -n . || test_report "$sample_data" "$result" "$expected_result"
...
sample_data="destnum $destnum; smsc $smsc; message $message"
expected_result="\
\x1E\x00\x0C\x02\x00\x59\
\x00\x01\x00\x01\x02\x00\
\x07\x91\x16\x14\x91\x09\x10\xF0\x00\x00\x00\x00\
\x15\x00\x00\x00\x33\
\x0A\x91\x40\x30\x87\x00\x47\x00\x00\x00\x00\x00\
\xA7\x00\x00\x00\x00\x00\x00\xC8\x34\x28\xC8\x66\xBB\x40\x54\x74\x7A\x0E\x6A\x97\xE7\xF3\xF0\xB9\x0C\xBA\x87\xE7\xA0\x79\xD9\x4D\x07\xD1\xD1\xF2\x77\xFD\x8C\x06\x19\x5B\xC2\xFA\xDC\x05\x1A\xBE\xDF\xEC\x50\x08\x01\
\x43\x00\x6A\x52"
result="$(fbus_encapsulate "$(build_sms_frame)")"
test "$result" == "$expected_result" && echo -n . || test_report "$sample_data" "$result" "$expected_result"
